...
const StackPowersSection = () => {
  ...
  return (
    <section
      ref={ref}
      className="py-20 bg-gradient-to-b from-gray-800 to-gray-900 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            We leverage cutting-edge technologies trusted by industry leaders
            worldwide
          </p>
        </div>
        ...
        <div
          className={`flex flex-wrap justify-center gap-4 mb-12 transition-all duration-600 ease-out delay-200 ${
            inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
          }`}
        >
