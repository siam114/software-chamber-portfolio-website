        ...
        <div className="relative flex items-center justify-center mb-20">
          <div
            className={`transition-all duration-600 ease-out ${
              inView ? "scale-100 opacity-100" : "scale-96 opacity-0"
            }`}
          >
            {/* Globe Background */}
            <div className="relative w-[500px] h-[500px]">
              ...
              {processSteps.map((step, index) => {
                const x =
                  250 + radius * Math.cos(((step.angle - 90) * Math.PI) / 180);
                const y =
                  250 + radius * Math.sin(((step.angle - 90) * Math.PI) / 180);
                const isVisible =
                  inView &&
                  strokeOffset <
                    circumference - (circumference * step.angle) / 360;
                ...
                return (
                  ...
                  >
                    <div
                      className={`w-16 h-16 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-full flex items-center justify-center text-white shadow-lg hover:scale-110 transition-all duration-300 ${
