  ...
  const services = [
    {
      ...
      description:
        "Software Chamber specializes in creating powerful, scalable, and secure e-commerce solutions.",
      featured: false,
    },
    {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div
          className={`flex justify-between items-center mb-16 transition-all duration-700 ease-out ${
