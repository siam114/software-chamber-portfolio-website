...
const FooterSection = () => {
  return (
    <footer className="py-10 px-4" style={{ backgroundColor: "#0f172a" }}>
        ...
        <div className="grid lg:grid-cols-3 gap-16 mb-10">
          ...
          <div className="lg:col-span-1">
            <p className="text-gray-400 leading-relaxed mb-10">
              A new era of energy, elegance, and elite competition begins. Where
              passion meets performance on the court like never before.
            </p>
