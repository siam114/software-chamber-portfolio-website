...
const FaqSection = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "Ya genius dong, maos aplikasi chat aja berbayar alk. Lo kalo nanya yang bener dong. Bayangan gw kalo aplikasi ini berbayar, masa gak chat lu harus bayar setiap kali nyalakan. Kalo lu mau bayar mendinp gabs MUIS aja sih."
    },
    {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-16">
          <h1 className="text-3xl md:text-5xl text-center font-bold text-gray-900 mb-8 leading-tight">
            ...
            <span className="inline-flex items-center">
              <Star className="w-8 h-8 text-teal-500 mr-2" fill="currentColor" />
              Common Questions
            </span>{' '}
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center">
            ...
            <div className="ml-8 h-px bg-gray-200 flex-1" style={{ width: '200px' }}></div>
          </div>
